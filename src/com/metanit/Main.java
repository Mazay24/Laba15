...
public class Main {
    public static void main(String[] args) {
        Clothes[] clothes = {
                new Atelier.TShirt(ClothesSize.M, "Черная", 100),
                new Atelier.TShirt(ClothesSize.S, "Синяя", 80),
                new Atelier.Trousers(ClothesSize.XXS, "Красная", 5000),
                new Atelier.Trousers(ClothesSize.M, "Бежевая", 6000),
                new Atelier.Skirt(ClothesSize.XS, "Серая", 1000),
                new Atelier.Skirt(ClothesSize.L, "Белая", 1300),
                new Atelier.Tie(ClothesSize.XS, "Морской Волны", 2400),
                new Atelier.Tie(ClothesSize.XXS, "Бардовая", 3100),
        };
